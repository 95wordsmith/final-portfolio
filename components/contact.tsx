...
const iconStyles =
  "stroke-secondary hover:scale-110 hover:stroke-primary size-9";
const sideDetails = [
  {
  ...
  {
    icon: <CircleCheckBig className={iconStyles} />,
        ...
        <div className="flex-initial">
          {sideDetails.map((ele, index) => (
            <motion.div
              ...
              custom={index}
            >
              <Card className="mb-7 flex flex-col items-center justify-center p-10">
                {ele.icon}
